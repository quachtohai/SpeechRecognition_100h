...
wavs_paths = "datasets_wavs"
saveto = "./datasets"
wavs = glob("{}/**/*.wav".format(wavs_paths), recursive=True)

id_to_text = PreprocessData().get_id_to_text()
...
class CustomSchedule(keras.optimizers.schedules.LearningRateSchedule):
    ...
    def calculate_lr(self, epoch):
        ...
        warmup_lr = (
            self.init_lr
            + ((self.lr_after_warmup - self.init_lr) / (self.warmup_epochs - 1)) * 1000
        )
...
history = model.fit(ds, validation_data=val_ds, callbacks=[display_cb], epochs=1000)
